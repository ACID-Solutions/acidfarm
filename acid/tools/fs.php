...
class AcidFs
{
	 ...
	 * @return array
	 */
	public static function importMimeArray($source_url='http://svn.apache.org/repos/asf/httpd/httpd/trunk/docs/conf/mime.types'){
		$s=array();
		foreach(@explode("\n",@file_get_contents($source_url))as $x) {
