		...
		<table style="border-collapse:collapse;" cellspacing="0" cellpadding="0" >
			<tr><td>
				<a href="<?php echo Acid::get('url:system'); ?>">
					<img border="0" src="<?php echo $base_img; ?>mail/logo.png" alt="<?php echo Acid::get('site:name'); ?>" style="display:block; margin:0px;" />
				</a>
			</td><td>
				<a href="#">
					<img  border="0" src="<?php echo $base_img; ?>mail/dev-logo.png" alt="*" style="display:block;  margin:0px;" />
				</a>
			</td></tr>
		</table>
		</td></tr>
