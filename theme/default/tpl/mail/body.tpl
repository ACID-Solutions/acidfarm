		...
		<table id="corps" cellpadding="0" cellspacing="0" style="width:642px; font-family:arial; margin:auto; border-collapse:collapse; " >
			...
			<tr id="footer" >
				<td style="font-size:10px; font-style:italic; color:<?php echo $color; ?>; " >
					...
					<tr>
						<td>
						<?php echo Acid::trad('mail_footer_auto_generation',array('__NAME__'=> Acid::get('site:name'))); ?><br />
						<?php echo Acid::trad('mail_footer_no_response',array('__LINK__'=>'<a href="'.Route::buildUrl('contact',array(),true).'">'.Acid::trad('mail_footer_contact_form').'</a>')); ?>
						</td>
					</table>
				</td>
			</tr>
