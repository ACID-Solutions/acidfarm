...
INSERT INTO `acid_actu` (`id_actu`, `title`, `head`, `content`, `adate`, `active`) VALUES
...
INSERT INTO `acid_page` (`id_page`, `title`, `ident`, `adate`, `content`, `active`, `id_gallery`) VALUES
(1, 'Home Page', 'home', '2011-12-08 12:55:33', '<p style="text-align: left;"><span id="result_box" lang="en"><strong><span class="hps">Welcome to</span> <span class="hps">the home page</span> <span class="hps">AcidFarm</span> !</strong><br /> <span class="hps">Thank you for choosing</span> <span class="hps">our solution.</span></span></p>', 0, 0),
(2, 'AcidFarm', 'acidfarm', '2011-03-01 11:50:09', '<p>AcidFarm is a open source framework developped by Acid-Solutions SARL.</p>\r\n<p>Primarily developed for web developers who want to build a PHP Website more easily, Acidfarm was made in jully 2010.</p>\r\n<p>AcidFarm in few words :</p>\r\n<ul>\r\n<li>A Securized FrameWork</li>\r\n<li>A Lightweight FrameWork</li>\r\n<li>A Flexible Framework</li>\r\n</ul>', 1, 0);
